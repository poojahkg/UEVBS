...
function [tp6, powcons6] = cluster6(X,disratee,num_ue)
    disrate=disratee;
    figure;
    alpha=0.5;
    beta=0.5;
   ...
   for j=1:numel(csix(:,1))
    ...
    thwoa=[];
    thwoa=[throughput(rt1,100e7) throughput(rt2,100e7) throughput(rt3,100e7) throughput(rt4,100e7) throughput(rt5,100e7) throughput(rt6,100e7)];
    ...
    th4temp=[throughput(maxx4g,20e7) throughput(maxx4g,20e7) throughput(maxx4g,20e7) throughput(maxx4g,20e7) throughput(maxx4g,20e7) throughput(maxx4g,20e7)]; 
    ...
    pctot = pc1+pc2+pc3+pc4+pc5+pc6;
    
    powcons6 = 10*log10(pctot*1000);
    
    figure;
    bar([1 2 3 4 5 6], [pc1 pc2 pc3 pc4 pc5 pc6], 0.4);
    ...
    figure;
    thh=[];
    thwa=[throughput(maxx1,100e7) throughput(maxx2,100e7) throughput(maxx3,100e7) throughput(maxx4,100e7) throughput(maxx5,100e7) throughput(maxx6,100e7)];
    
    %Throughput of the algorithm selection
    thh=[th4temp;thwoa;thwa];
    barX = categorical({'Cluster 1','Cluster 2','Cluster3','Cluster 4','Cluster 5','Cluster 6'});
    barX= reordercats(barX,{'Cluster 1','Cluster 2','Cluster3','Cluster 4','Cluster 5','Cluster 6'});
    ...
    figure;
    bar([1 2 3 4 5 6],[q1 q2 q3 q4 q5 q6],0.4);
